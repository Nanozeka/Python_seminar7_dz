...
def main_menu(): 
    ...
    if choice == "1": 
        ...
        print("Phone_book - найдем любого!") 
    else: 
...
def searchcontact(): 
    ...
    for line in filecontents: 
        if searchname in line: 
            ...
            break 
    if found == False: 
        print(f"Контакт {searchname} не найден в справочнике") 
...
def newcontact(): 
    ...
    account = input("Введите вашу должность: ") 
    contactDetails =(f"{key};" + firstname + " " + lastname + ";" + phoneNum + ";" + account +  "\n") 
    myfile = open(filename, "a") 
